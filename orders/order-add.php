...
<div class="container">
  ...
  <div class="container">
    <form name="orderAddForm" class="row justify-content-between">

      <div class="col-7 d-flex flex-wrap p-0 pe-5">
        ...
        <!-- 付款方式 -->
        <div class="col-6 mb-3 ps-3">
          <label for="paymentMethod" class="form-label mb-3">付款方式</label>
          <div class="col-12">
        ...
        <div class="col-12 d-flex flex-column">
          ...
          <div class="form-check mb-2">
            <input class="form-check-input" type="radio" id="useSavedAddress" name="groupAddressType" value="" checked>
            <label class="form-check-label" for="useSavedAddress">常用收件地址</label>
            <!-- 常用地址視窗按鈕 -->
      ...
      <div class="col-5 p-4 order-list position-relative d-flex flex-column">
        ...
        <div class="col-12 mb-4">
          <input type="text" class="form-control search-product" id="searchProduct" placeholder="請輸入商品編號或名稱完成新增">
      ...
      <input type="submit" class="btn btn-primary my-5" value="新增訂單">
